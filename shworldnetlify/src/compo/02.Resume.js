...
function Resume() {
    ...
    return (
        <body style={styleBody}>
            ...
            2022.8.10 ~ 2022.9.5<br></br>
            EfficientNet, PyTorch, Flask, HTML, CSS3.<br></br>
            증상별 총 여섯개 모델의 4class 딥러닝 이미지 분석을 통한 두피 타입<br></br>
            판별 모델 구현 및 웹페이지 연동.
            <h2>라이프 컨시어지 AI 비서</h2>
            <a href="https://velog.io/@shlog/project.nd" target='_blank'>Project Review</a><br></br>
            ...
            2022.9.24 ~ 2022.12.14<br></br>
            광주인공지능사관학교 홍보 미션 수행 및 개인 학습 블로그 운영.<br></br>
            우수 서포터즈 선정.
            <h2>광주인공지능사관학교 알고리즘 경진대회</h2>
            <a href="https://velog.io/@shlog/알고리즘-경진대회" target='_blank'>Competition Review</a><br></br>
            ...
            2022.6.20~ 2022.12.14<br></br>
            Python, Machine Learning, Deep Learning, HTML, CSS3,<br></br>
